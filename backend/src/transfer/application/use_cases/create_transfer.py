...
from src.transfer.domain.dtos import TransferAlbumCreateDTO, TransferPlaylistCreateDTO
...
class CreateTransferUseCase:
    ...
    async def execute(self, dto: TransferPlaylistCreateDTO | TransferAlbumCreateDTO) -> Transfer:
